    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-5 pt-5 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-[0_4px_20px_rgba(244,114,182,0.03)] border border-pink-100/50 flex flex-col gap-4">
          <h2 className="font-serif italic text-lg text-pink-deep font-bold border-b border-pink-50 pb-2">
            Reminder Intervals
          </h2>
          <p className="font-sans text-gray-400 text-xs font-semibold -mt-2 leading-relaxed">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <div className="font-sans text-[10px] text-gray-400 mt-0.5 font-medium">{opt.desc}</div>
                </div>
        ...
        <div className="bg-white rounded-3xl p-5 shadow-[0_4px_20px_rgba(244,114,182,0.03)] border border-pink-100/50 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            {exportStatus && (
              <div className="text-center font-sans text-xs font-bold text-green-500 animate-pulse">
                {exportStatus}
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl bg-white text-gray-500 hover:bg-gray-50 font-bold text-xs transition-all border border-gray-200/60 cursor-pointer flex items-center justify-center gap-2"
            >
        ...
        {/* Info footer */}
        <div className="text-center text-[10px] text-gray-400 font-bold uppercase tracking-wider py-4">
